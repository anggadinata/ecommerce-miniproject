...
```bash
git remote add encore encore://ecommerce-app-59ci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ecommerce-app-59ci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ecommerce-app-59ci/settings/integrations/github)

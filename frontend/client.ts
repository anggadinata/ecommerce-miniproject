...
export namespace orders {
    ...
    export class ServiceClient {
         ...
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_orders_get_get>> {
            // Now make the actual call to the API
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { categories as api_products_categories_categories } from "~backend/products/categories";
...
export namespace products {
    ...
    export class ServiceClient {
         ...
         */
        public async categories(): Promise<ResponseType<typeof api_products_categories_categories>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/products/categories`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_products_categories_categories>
        }
